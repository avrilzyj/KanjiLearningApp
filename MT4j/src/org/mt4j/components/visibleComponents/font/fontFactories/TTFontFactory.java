...
//		logger.setLevel(ILogger.DEBUG);
	...
	public static String defaultCharacters = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ晾扇吞右abcdefghijklmnopqrstuvwxyz徉殍盱篁<>|,;.:-_#'+*!\"�%&/()=?磠[]}\\@ōūあいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみもめもやゆよらりるれろわをんがぎぐげござじずぜぞだずぜぞばびぶべぼぱぴぷぺぽっゃゅょぢ";
