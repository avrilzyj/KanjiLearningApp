...
//	        ctx.getCSSEngineForElement(null).
	...
	private void traverseSVGDoc(Node node, ArrayList<MTComponent> comps){
		...
		//jedes tag, da锟�eine transform attribut hat
		//behandelt werden!
		//Default
		currentLocalTransformMatrix = new Matrix();
...
//							  fontChanged = true;
							  ...
							  //-> statt graphicsnode /stylable node 锟絙ergeben? - SVGOMTextElement is nicht instanceof graphicsnode..
...
//                	logger.error("Radial gradient encountered -> Not supported yet.");
    ...
    // - wie shapes ohne stroke mit outline= gradient zeichnen f锟絩 antialiasing?
...
//		}
		...
		logger.debug("Gradient angle: " + gradAngle + "锟�");
